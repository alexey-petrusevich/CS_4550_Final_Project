  ...
  def get_playlist_tracks(playlist_uri, token) do
    ...
    tracks = Enum.map(
      ...
      fn item ->
        ...
        genre = "Hip Hop"; # TODO update after artist API call
        ...
        %{title: title, track_uri: track_uri, artist: artist, genre: genre}
      end
    )
    tracks
  end
     ...
     fn track ->
       ...
       Server.Songs.create_song(
         %{artist: track.artist,
              ...
              party_id: party_id, played: false, genre: track.genre,
