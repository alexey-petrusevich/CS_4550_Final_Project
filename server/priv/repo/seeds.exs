...
austin = Repo.insert!(%User{username: "Austin", name: "Austin Kim", email: "kim.a@northeastern.edu", password_hash: pass_hash, impact_score: 196})
...
party1 = Repo.insert!(%Party{name: "Trevor's Birthday", roomcode: "1234", description: "Trevor's 21st birthday", host_id: benjamin.id, is_active: false})
